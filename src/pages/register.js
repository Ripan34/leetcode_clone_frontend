            ...
            <div className={styles.container}>
                <div className={styles.box}>
                    ...
                    <form className={styles.formCont}>
                        <input placeholder="Username" className={styles.inp}/>
                        <input placeholder="E-mail" className={styles.inp}/>
                        <input placeholder="Password" className={styles.inp}/>
                        <input placeholder="Confirm password" className={styles.inp}/>
                        <button className={styles.btn}>Sign Up</button>
                        <div className={styles.displayText}>
                            Have an account? <Link to="/signin" className={styles.displayText}>Sign In</Link>
                        </div>
                    </form>
